...
def make_text(color, word):
    stim = stimuli.TextLine(text=word, text_colour=color)
    stim.preload()
    return stim

def make_instruction():
    text = ("Click on 'ENTER' if the word and color match, and press 'F' otherwise.\n"
            "Press 'SPACE' when you are ready to begin!")
    heading = "Instructions for the Stroop Effect Experiment"
